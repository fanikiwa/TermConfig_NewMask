...
{
    public class KruAllCommBaseRepository<T> where T : class
    {
        #region Constructors
        public KruAllCommBaseRepository() { }
        ...
        internal KruAll_Comm_Entities _contextKruAllComm = new KruAll_Comm_Entities();
        ...
        {
            IQueryable<T> query = _contextKruAllComm.Set<T>();
            return query;
        }
        ...
        protected virtual void Add(T entity)
        {
            ...
            _contextKruAllComm.Set<T>().Add(entity);
        }
        ...
        protected virtual IQueryable<T> FindBy(Expression<Func<T, bool>> predicate)
        {
            ...
            IQueryable<T> query = _contextKruAllComm.Set<T>().Where(predicate);
            return query;
        }
        ...
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            _contextKruAllComm.Set<T>().Remove(entity);
        }

        protected virtual void Edit(T entity)
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            _contextKruAllComm.Entry(entity).State = EntityState.Modified;
        }

        protected virtual void Save()
        {
            _contextKruAllComm.SaveChanges();
        }
        ...
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            return _contextKruAllComm.Set<T>().Contains(entity);
        }
