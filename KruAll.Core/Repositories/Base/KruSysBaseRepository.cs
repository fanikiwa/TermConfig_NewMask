...
{
    public class KruSysBaseRepository<T> where T : class
    {
        #region Constructor
        public KruSysBaseRepository() { }

        #endregion

        #region Properties

        internal KruSys_Entities _contextKruSys = new KruSys_Entities();
        ...
        {
            IQueryable<T> query = _contextKruSys.Set<T>();
            return query;
        }
        ...
        protected virtual void Add(T entity)
        {
            ...
            _contextKruSys.Set<T>().Add(entity);
        }
        ...
        protected virtual IQueryable<T> FindBy(Expression<Func<T, bool>> predicate)
        {
            ...
            IQueryable<T> query = _contextKruSys.Set<T>().Where(predicate);
            return query;
        }
        ...
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            _contextKruSys.Set<T>().Remove(entity);
        }

        protected virtual void Edit(T entity)
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            _contextKruSys.Entry(entity).State = EntityState.Modified;
        }

        protected virtual void Save()
        {
            _contextKruSys.SaveChanges();
        }
        ...
        {
            if (entity == null) throw new ArgumentNullException("Entity should not be null");
            return _contextKruSys.Set<T>().Contains(entity);
        }
