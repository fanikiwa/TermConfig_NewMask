<%@ Page Title="TM 900bc" Language="C#" MasterPageFile="~/MasterPages/ZkTerminals.Master" AutoEventWireup="true" CodeBehind="TM900bc.aspx.cs" Inherits="TermConfig_NewMask.Content.TM900bc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="Styles/ImportantInfoDialog.css"
        type="text/css" media="all" />
    <link rel="stylesheet" href="Styles/TM900bc.css"
        type="text/css" media="all" />
    ...
    <script lang="javascript" type="text/javascript" src="Scripts/TM900bc.js"></script>
</asp:Content>
    ...
    <section class="divcontentBottom">
            ...
            <section class="bttmsec1">
                <section class="bttmsec1left">
                    ...
                    <section class="bttmsec1txts">
                        <dx:ASPxComboBox ID="ddlCurrentZkTerminalInstance" runat="server" ValueType="System.String" CssClass="txtbttmsec2 IDHolder" TextField="ID" ValueField="ID" Theme="Office2003Blue"></dx:ASPxComboBox>
                        ...
                        <asp:TextBox ID="txtTermTyp" runat="server" Text="TM 900bc" ReadOnly="true" Enabled="false" BackColor="White" CssClass="txtTermTyp"></asp:TextBox>
                    ...
                    <section class="leftBttmsec">
                        ...
                        <section class="bttmsecLongTxt">
                            <asp:CheckBox ID="chkpersonnelNumberPin" runat="server" CssClass="chkBttm" Style="display: none;" />
                            <asp:CheckBox ID="CheckBox2" runat="server" CssClass="chkBttm" Style="display: none;" />
                            <asp:CheckBox ID="chkUseAccessControl" runat="server" CssClass="chkBttm" />
                            <asp:CheckBox ID="chkPInPers" runat="server" CssClass="chkBttm" />
                            <asp:CheckBox ID="chkFingerPrint" runat="server" CssClass="chkBttm" />
                ...
                <section class="bttmsec1right">
                    <section class="tab1leftsection5">
                        <section class="photo">
                            <div id="Photoholder" class="sec1pics tm900bc">
                            </div>
            ...
            <section class="bttmsec5">
                ...
                <section class="bttmsec5Right">
                    <section class="lblLeft">
                        <asp:Label ID="Label14" runat="server" Text="<%$ Resources:LocalizedText, functionKey1 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:LocalizedText, functionKey2 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label16" runat="server" Text="<%$ Resources:LocalizedText, functionKey3 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:LocalizedText, functionKey4 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:LocalizedText, functionKey5 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label20" runat="server" Text="<%$ Resources:LocalizedText, functionKey6 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:LocalizedText, functionKey7 %>" CssClass="lblbttmsec23"></asp:Label>
                        <asp:Label ID="Label21" runat="server" Text="<%$ Resources:LocalizedText, functionKey8 %>" CssClass="lblbttmsec23"></asp:Label>
                    </section>

                    <section class="txtRight">
                        <dx:ASPxComboBox ID="cbofunctionKey1" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey2" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey3" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey4" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey5" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey6" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey7" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                        <dx:ASPxComboBox ID="cbofunctionKey8" runat="server" ValueType="System.String" CssClass="ddlFunctions" TextField="StatusName" ValueField="StatusNr" Theme="Office2003Blue"></dx:ASPxComboBox>
                    </section>
                </section>
            </section>
                ...
                <section class="secTopGrid">
                    ...
                    <asp:Table runat="server" CssClass="tbtAddReader" CellPadding="0" CellSpacing="0">
                        <asp:TableRow CssClass="tblRowReader2">
                            ...
                            <asp:TableCell CssClass="tblCellSmallWith2newtop">
                        ...
                        <asp:TableRow CssClass="tblRowReader">
                            ...
                            <asp:TableCell CssClass="tblCells">
                                <dx:ASPxComboBox ID="ddlTIDirection" runat="server" ValueType="System.String" Theme="Office2003Blue" CssClass="drpDirection">
                                    <Items>
        ...
        <section class="divcontentBottomRight">
            ...
            <section class="secpart2" style="display: none;">
                <dx:ASPxGridView ID="grdZkTerminals" runat="server" AutoGenerateColumns="False" EnableTheming="True" Theme="Office2003Blue" Width="100%" ClientInstanceName="grdZkTerminals" KeyFieldName="ID" SettingsBehavior-ProcessSelectionChangedOnServer="True">
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="ID" FieldName="ID" Visible="False" VisibleIndex="1">
                        </dx:GridViewDataTextColumn>
