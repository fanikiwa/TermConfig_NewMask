...
{
    public partial class TM900bc : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    if (!isNewRedirectMode) BindSelectedTerminalControls(selectedTermId, curChildId);
                    else
                    {
                ...
                {
                    if (!isNewRedirectMode) BindInputControls(selectedTermId);
                    else
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "Redirect to New Instance Creation",
                            "setTimeout(function() { checkForNewRedirectMode() }, 500)", true);
        ...
        public void BindSelectedTerminalControls(string terminalId, int childId)
        {
            try
            {
                ...
                ddlTerminalType.Value = lst[0].TerminalId.ToString();
                ...
                // chkAPPosting.Checked = lst[0].TerminalUtilities.FirstOrDefault().HasAPPosting;
                if (lst[0].TerminalUtilities.Count != 0)
                {
                    chkPInPers.Checked = lst[0].TerminalUtilities.FirstOrDefault().HasPersNoPin;
                    chkUseAccessControl.Checked = lst[0].TerminalUtilities.FirstOrDefault().HasAPPosting;
                    chkFingerPrint.Checked = lst[0].TerminalUtilities.FirstOrDefault().HasFPRead;
                ...
                //cbofunctionKey1.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 1) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 1).FunctionKeyText : "";
                //cbofunctionKey2.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 2) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 2).FunctionKeyText : "";
                //cbofunctionKey3.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 3) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 3).FunctionKeyText : "";
                //cbofunctionKey4.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 4) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 4).FunctionKeyText : "";
                //cbofunctionKey5.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 5) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 5).FunctionKeyText : "";
                //cbofunctionKey6.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 6) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 6).FunctionKeyText : "";
                //cbofunctionKey7.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 7) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 7).FunctionKeyText : "";
                //cbofunctionKey8.Value = lst[0].TerminalFunctionKeys.Any(x => x.FunctionKeyNr == 8) ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 8).FunctionKeyText : "";
                //BindReaderInstances(childId);

                //cbofunctionKey1.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 1).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 1).FunctionKeyText : "0";
                //cbofunctionKey2.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 2).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 2).FunctionKeyText : "0";
                //cbofunctionKey3.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 3).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 3).FunctionKeyText : "0";
                //cbofunctionKey4.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 4).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 4).FunctionKeyText : "0";
                //cbofunctionKey5.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 5).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 5).FunctionKeyText : "0";
                //cbofunctionKey6.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 6).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 6).FunctionKeyText : "0";
                //cbofunctionKey7.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 7).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 7).FunctionKeyText : "0";
                //cbofunctionKey8.Value = lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 8).FunctionKeyText != null ? lst[0].TerminalFunctionKeys.FirstOrDefault(x => x.FunctionKeyNr == 8).FunctionKeyText : "0";
        ...
        public void BindInputControls(string terminalId)
        {
            ...
            try
            {
                if (terminalId == null)
                {
                    ...
                    terminal = repo.GetTerminalbyType("TM 900bc");
                    ...
                    if (termConf != null)
                    {
                        ...
                        grdZkTerminalCon.FocusedRowIndex = grdZkTerminalCon.FindVisibleIndexByKeyValue(terminalId);
                        lst = terminalConfigRepository.GetAllTerminalConfig().Where(x => x.ID == Convert.ToInt32(terminalId)).ToList();
                    }
                    else
                    {
                        return;
                ...
                {
                    lst = terminalConfigRepository.GetAllTerminalConfig().Where(x => x.TerminalId == Convert.ToInt32(terminalId)).ToList();
                }
                ddlCurrentZkTerminalInstance.DataSource = lst;
                ddlCurrentZkTerminalInstance.DataBind();
        ...
        protected void BindddlTerminalType()
        {
            try
            {
                ...
                ddlTerminalType.DataSource = lst;
        ...
        protected void grdZkTerminals_DataBound(object sender, EventArgs e)
        {
            try
            {
                ...
                ddlTerminalType.Value = terminal.ID.ToString();
...
string functionKey1, string functionKey2, string functionKey3, string functionKey4, string functionKey5, string functionKey6, string functionKey7, string functionKey8, bool IsActiveTerminal, int RelaySwitching, bool PersNoPin,
            string readerInternDesc, string readerExternDesc, int readerInternDirec, int readerExternDirec, string readerRelayTime)
        {
            TerminalConfigRepository terminalConfigRepository = new TerminalConfigRepository();
        ...
        public static TerminalZkDto UpdateZkTerminalInstance(string Id, string terminalType, string terminalId, string usertermID, string terminalDescription, string serialNumber, string linkType,
                string ipAddress, int ipPort, bool backToReadFingerPrint, bool APPosting, bool ProfFirmware, string infoText1, string infoText2, string infoText3, string infoText4,
string functionKey1, string functionKey2, string functionKey3, string functionKey4, string functionKey5, string functionKey6, string functionKey7, string functionKey8, bool IsActiveTerminal, int RelaySwitching, bool PersNoPin,
             string readerInternDesc, string readerExternDesc, int readerInternDirec, int readerExternDirec, string readerRelayTime, string internReaderId)
        {
            TerminalConfigRepository terminalConfigRepository = new TerminalConfigRepository();
            TerminalConfig zkInstance = null;
            TerminalZkDto zkDto = new TerminalZkDto();
        ...
        protected void ddlTerminalType_SelectedIndexChanged(object sender, EventArgs e)
        {
            TerminalRepository repo = new TerminalRepository();
            Terminal terminal = new Terminal();
            try
            {
                var staticTerminalId = ddlTerminalType.Value;
                terminal = repo.GetTerminalbyID(Convert.ToInt32(staticTerminalId));
                string curTerminalPage = terminal.TerminalPage;
        ...
        private static ZKTerminal getCurrentTerminal(string Description, string IPAddress)
        {
            ...
            //_currentTerminal.HasBiometricData = true;
        ...
        protected static void CreateTerminalInstanceReader(long terminalInstanceId, string name, string desc, bool status, int direction, string relayTime)
        {
            try
            {
        ...
        protected static void UpdateTerminalInstanceReader(long terminalInstanceId, bool status, string name, string desc, int direction, string relayTime, string readerId)
        {
            try
            {
        ...
        protected void BindTerminalInstanceValues(int readerId, string readerInfo, string readerInfo2, string readerType, string readerType2, string name, int? direction, int? status, int? relayTime)
        {
            lblTIId.Text = readerId.ToString();
            lblExId.Text = "1a";
            lblTIInfo.Text = readerInfo;
            //lblReaderInfo2.Text = readerInfo2;
            lblTILaserType.Text = readerType;
            lblExLaserType.Text = readerType2;
        ...
        protected void BindReaderInstances(long termId)
        {
            ...
            foreach (var reader in Readers)
            {
                ...
                //string[] readerInfo = reader.ReaderInfo.Split('/');
                string[] readerType = reader.ReaderType.Split('/');
                BindTerminalInstanceValues(reader.ReaderID, reader.ReaderInfo, reader.ReaderInfo, readerType[0], readerType[1], reader.Name, reader.Direction, reader.Status, reader.RelayTime);
            }
        }
        public static void GetReadersInstances(long termId, TerminalZkDto zkDto)
        {
            ...
            foreach (var reader in Readers)
            {
                ...
                zkDto.readerInfoIntern_2 = reader.ReaderInfo;
                zkDto.readerTypeIntern = readerType[0];
                zkDto.readerTypeIntern_2 = readerType[1];
        ...
        public static TerminalZkDto GetTerminalConfigbyTermID(int TermID)
        {
            try
            {
                ...
                TM900bc _TM900bcfrm = new TM900bc();
                ...
                if (TerminalConfig != null)
                {
                    _TerminalDto = _TM900bcfrm.ConvertTerminalToDto(TerminalConfig);
                }
                return _TerminalDto;
            }
            catch (Exception ex)
